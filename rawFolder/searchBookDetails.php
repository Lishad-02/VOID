...
if ($book['available_copies'] == 0) {
    $latest_borrow_sql = "SELECT due_date FROM borrowed_books WHERE book_id = ? ORDER BY borrow_id DESC LIMIT 1";
...
<head>
    ...
    <style>
        /* Styling for the Book Summary Page */
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            ...
            background-image: url('999.jpg'); /* Background image */
...
<body>
    <div class="summary-container">
        ...
        <?php else: ?>
            ...
            <!-- Reserve Button linking to another page without modifying backend logic -->
            <a href="reserveB.php?book_id=<?php echo $book_id; ?>" class="reserve-link">
